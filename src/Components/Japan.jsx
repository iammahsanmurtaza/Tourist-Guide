    ...
    <>
      <div className='px-4 sm:px-6 md:px-10 mt-10'>
        <div className='flex flex-col md:flex-row items-center gap-6'>
          <img
            src='https://www.grand-seiko.com/us-en/-/media/Images/Product--Image/All/GrandSeiko/2022/02/19/22/10/SBGM221G/SBGM221G.png'
            alt='Grand Seiko'
          ...
          <div className='text-center md:text-left'>
            ...
            <div
              ...
              '
            >
              Grand Seiko wears silence like royalty. Every line is sculpted
